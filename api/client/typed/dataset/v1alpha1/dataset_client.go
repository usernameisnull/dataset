...
// DatasetV1alpha1Client is used to interact with features provided by the dataset group.
type DatasetV1alpha1Client struct {
	restClient rest.Interface
}

func (c *DatasetV1alpha1Client) Datasets(namespace string) DatasetInterface {
...
// NewForConfigAndClient creates a new DatasetV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*DatasetV1alpha1Client, error) {
	config := *c
	setConfigDefaults(&config)
...
func setConfigDefaults(config *rest.Config) {
	gv := datasetv1alpha1.SchemeGroupVersion
